...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal("cities", ["Country"])

        # Adding M2M table for field alt_names on 'Country'
        m2m_table_name = db.shorten_name("cities_country_alt_names")
        db.create_table(
            m2m_table_name,
            (
                (
                ...
                ("country", models.ForeignKey(orm["cities.country"], null=False)),
                (
                    "alternativename",
                    models.ForeignKey(orm["cities.alternativename"], null=False),
                ),
            ),
        )
        ...
        m2m_table_name = db.shorten_name("cities_country_neighbours")
        db.create_table(
            m2m_table_name,
            (
                (
                ...
                ("from_country", models.ForeignKey(orm["cities.country"], null=False)),
                ("to_country", models.ForeignKey(orm["cities.country"], null=False)),
            ),
        )
            ...
            (
                ...
                (
                    ...
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        to=orm["cities.Country"]
                    ),
                ),
            ),
        )
        db.send_create_signal("cities", ["Region"])

        # Adding M2M table for field alt_names on 'Region'
        m2m_table_name = db.shorten_name("cities_region_alt_names")
        db.create_table(
            m2m_table_name,
            (
                (
                ...
                ("region", models.ForeignKey(orm["cities.region"], null=False)),
                (
                    "alternativename",
                    models.ForeignKey(orm["cities.alternativename"], null=False),
                ),
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "region",
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        to=orm["cities.Region"]
                    ),
                ),
            ),
        )
        db.send_create_signal("cities", ["Subregion"])

        # Adding M2M table for field alt_names on 'Subregion'
        m2m_table_name = db.shorten_name("cities_subregion_alt_names")
        db.create_table(
            m2m_table_name,
            (
                (
                ...
                ("subregion", models.ForeignKey(orm["cities.subregion"], null=False)),
                (
                    "alternativename",
                    models.ForeignKey(orm["cities.alternativename"], null=False),
                ),
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "region",
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        to=orm["cities.Region"], null=True, blank=True
                    ),
                ),
                (
                    "subregion",
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        to=orm["cities.Subregion"], null=True, blank=True
                    ),
                ),
                (
                    "country",
        ...
        m2m_table_name = db.shorten_name("cities_city_alt_names")
        db.create_table(
            m2m_table_name,
            (
                (
                ...
                ("city", models.ForeignKey(orm["cities.city"], null=False)),
                (
                    "alternativename",
                    models.ForeignKey(orm["cities.alternativename"], null=False),
                ),
        ...
        db.send_create_signal("cities", ["District"])

        # Adding M2M table for field alt_names on 'District'
        m2m_table_name = db.shorten_name("cities_district_alt_names")
        db.create_table(
            m2m_table_name,
            (
                (
                ...
                ("district", models.ForeignKey(orm["cities.district"], null=False)),
                (
                    "alternativename",
                    models.ForeignKey(orm["cities.alternativename"], null=False),
                ),
        ...
        db.send_create_signal("cities", ["AlternativeName"])
        ...
        db.create_table(
            ...
            (
                ...
                (
                    "country",
                    self.gf("django.db.models.fields.related.ForeignKey")(
                        related_name="postal_codes", to=orm["cities.Country"]
                    ),
                ),
                (
                    "region_name",
        ...
        db.send_create_signal("cities", ["PostalCode"])

        # Adding M2M table for field alt_names on 'PostalCode'
        m2m_table_name = db.shorten_name("cities_postalcode_alt_names")
        db.create_table(
            m2m_table_name,
            (
                (
                ...
                ("postalcode", models.ForeignKey(orm["cities.postalcode"], null=False)),
                (
                    "alternativename",
                    models.ForeignKey(orm["cities.alternativename"], null=False),
                ),
    ...
    def backwards(self, orm):
        ...
        db.delete_table("cities_country")

        # Removing M2M table for field alt_names on 'Country'
        db.delete_table(db.shorten_name("cities_country_alt_names"))

        # Removing M2M table for field neighbours on 'Country'
        db.delete_table(db.shorten_name("cities_country_neighbours"))

        # Deleting model 'Region'
        db.delete_table("cities_region")
        ...
        db.delete_table("cities_subregion")

        # Removing M2M table for field alt_names on 'Subregion'
        db.delete_table(db.shorten_name("cities_subregion_alt_names"))

        # Deleting model 'City'
        db.delete_table("cities_city")

        # Removing M2M table for field alt_names on 'City'
        db.delete_table(db.shorten_name("cities_city_alt_names"))

        # Deleting model 'District'
        db.delete_table("cities_district")

        # Removing M2M table for field alt_names on 'District'
        db.delete_table(db.shorten_name("cities_district_alt_names"))

        # Deleting model 'AlternativeName'
        db.delete_table("cities_alternativename")

        # Deleting model 'PostalCode'
        db.delete_table("cities_postalcode")

        # Removing M2M table for field alt_names on 'PostalCode'
        db.delete_table(db.shorten_name("cities_postalcode_alt_names"))
    ...
    models = {
        ...
        "cities.city": {
            ...
            "alt_names": (
                ...
                [],
                {"to": "orm['cities.AlternativeName']", "symmetrical": "False"},
            ),
            "country": (
        ...
        "cities.country": {
            ...
            "neighbours": (
                "django.db.models.fields.related.ManyToManyField",
                [],
                {"related_name": "'neighbours_rel_+'", "to": "orm['cities.Country']"},
            ),
