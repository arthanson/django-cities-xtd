...
files = {
    ...
    "postal_code": {
        ...
        "urls": [
            url_bases["geonames"]["zip"] + "{filename}",
        ],
        "fields": [
            "countryCode",
            "postalCode",
...
plugin_hooks = [
    "country_pre",
    "country_post",  # noqa: E241
    "region_pre",
    "region_post",  # noqa: E241
    "subregion_pre",
    "subregion_post",  # noqa: E241
    "city_pre",
    "city_post",  # noqa: E241
    "district_pre",
    "district_post",  # noqa: E241
    "alt_name_pre",
    "alt_name_post",  # noqa: E241
    "postal_code_pre",
    "postal_code_post",  # noqa: E241
]
...
NO_LONGER_EXISTENT_COUNTRY_CODES = getattr(
    django_settings,
    "CITIES_NO_LONGER_EXISTENT_COUNTRY_CODES",
